            ...
            <div class="container-cafe">
                <div class="container-produto">
                    ...
                    <div class="texto-produto">
                        <p class="titulo-produto">Cafe com Chocolate</p>
                        <p class="descricao-produto">Um cafe doce com sabor de chocolate</p>
                    </div>
                ...
                <div class="container-produto">
                    <div class="container-foto">
                        <img src="css\img\cafe-cremoso.jpg">
                    </div>
                    <div class="texto-produto">
                        <p class="titulo-produto">Cafe Cremoso</p>
                        <p class="descricao-produto">Um cafe cremoso e saboroso</p>
                    </div>

                    <div class="container-setins">
                        <p class="preco-produto">R$ 7,00</p>
                        <div class="setins"><a class="icon-edit"><i class="bi bi-pencil-square"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        class="bi bi-pencil-square" viewBox="0 0 16 16">
                                        <path
                ...
                <div class="container-produto">
                    ...
                    <div class="texto-produto">
                        ...
                        <p class="titulo-produto">Cafe Decorado</p>
                        <p class="descricao-produto">Um cafe agradavel ao paladar e aos olhos</p>
                    </div>

                    <div class="container-setins">
                        <p class="preco-produto">R$ 9,00</p>
                        <div class="setins"><a class="icon-edit"><i class="bi bi-pencil-square"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        class="bi bi-pencil-square" viewBox="0 0 16 16">
                                        <path
                ...
                <div class="container-produto">
                    ...
                    <div class="texto-produto">
                        ...
                        <p class="titulo-produto">Cafe Preto</p>
                        <p class="descricao-produto">Um cafe encorpado e de sabor intenso</p>
                    </div>
                    <div class="container-setins">
